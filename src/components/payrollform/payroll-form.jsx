...
const PayrollForm = (props) => {
    ...
    const getDataById = (id) => {
        employeeService.getEmployeeById(id).then(data => {
              console.log("info  of data is ",data.data);
              let obj = data.data;
              console.log("info  after of data is ", obj);
              setData(obj.data); 
                ...
                <form className="form" action="#" onSubmit={save}>
                    ...
                    <div className="row">
                        ...
                        <div className="profile-radio-button">
                            <label >
                                <input type="radio" name="profilePic" checked={formValue.profilePic === '../../assets/Ellipse-1.png'} value="../../assets/Ellipse-1.png" onChange={changeValue} />
                                <img className="profile" src={profile1} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profilePic" checked={formValue.profilePic === '../../assets/Ellipse-3.png'} value="../../assets/Ellipse-3.png" onChange={changeValue} />
                                <img className="profile" src={profile2} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profilePic" checked={formValue.profilePic === '../../assets/Ellipse-7.png'} value="../../assets/Ellipse-7.png" onChange={changeValue} />
                                <img className="profile" src={profile3} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profilePic" checked={formValue.profilePic === '../../assets/Ellipse-8.png'} value="../../assets/Ellipse-8.png" onChange={changeValue} />
